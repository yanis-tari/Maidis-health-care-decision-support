...
@XmlRootElement(name = "monitoringExamPrescription")
@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlAccessorOrder(XmlAccessOrder.ALPHABETICAL)
@Namespace("http://maidis/medical-record#")
public class MonitoringExamPrescription extends Pami implements Serializable {

	/**
	 * 
	 */
	@Transient
	private static final long serialVersionUID = 1866145749005897065L;
	...
	public MonitoringExamPrescription(int mi_Id, int supMI_Id, int patient_Id,
	...
	public MonitoringExamPrescription(String codedPosology, Double duration,
			Date endDate, Boolean isALD, Boolean isFreePosology, Double nBox,
			Boolean not_substitute, String pathology, String posology,
			String reason, String route, Date startDate, String unit) {
		super();
	...
	public MonitoringExamPrescription() {
		super();
	}
	...
	public String toString() {
		return "MonitoringExamPrescription [codedPosology=" + codedPosology
				+ ", duration=" + duration + ", endDate=" + endDate
				+ ", isALD=" + isALD + ", isFreePosology=" + isFreePosology
				+ ", nBox=" + nBox + ", not_substitute=" + not_substitute
				+ ", pathology=" + pathology + ", posology=" + posology
				+ ", reason=" + reason + ", route=" + route + ", startDate="
