...
@XmlRootElement(name = "pami")
@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlSeeAlso({Allergy.class,SimpleExam.class, Drug.class, Symptom.class, Acte.class, Risk.class,
			Disposable.class, VaccinePrescription.class, BiologicExamPrescription.class,RealizedExam.class,
			RadiologicExamPrescription.class, RadiologicalExamResult.class, MonitoringExamPrescription.class, Pathology.class, NurseActe.class})
@Namespace("http://maidis/medical-record#")
public class Pami extends RdfBean<Pami> implements Serializable, PamiI{
	/**
	 * 
	 */
	@Transient
	private static final long serialVersionUID = 7938115874355763512L;
	private int mi_Id;
	...
	public Pami(int mi_Id, int supMI_Id, int patient_Id, int respUnit_Id,
	...
	public String toString() {
	 ...
	 static class Adapter extends XmlAdapter<Pami,PamiI> {
		 public PamiI unmarshal(Pami v) { return v; }
		 public Pami marshal(PamiI v) { return (Pami)v; }
		  }
