...
@XmlRootElement(name = "nurseActe")
@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlAccessorOrder(XmlAccessOrder.ALPHABETICAL)
@Namespace("http://maidis/medical-record#")
public class NurseActe extends Pami implements Serializable {

	/**
	 * 
	 */
	@Transient
	private static final long serialVersionUID = 3614622542051285644L;
	...
	public NurseActe(int mi_Id, int supMI_Id, int patient_Id, int respUnit_Id,
	...
	public NurseActe(String codedPosology, Double duration, Date endDate,
	...
	public Boolean getIsNot_substitute() {
	...
	public void setIsNot_substitute(Boolean not_substitute) {
		this.not_substitute = not_substitute;
	}
	...
	public String toString() {
		return "NurseActe [codedPosology=" + codedPosology + ", duration="
